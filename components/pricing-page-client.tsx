  ...
  return (
    ...
    >
      ...
      <section className="mx-auto mt-5 max-w-7xl rounded-[28px] border border-[#D9E2F0] bg-[#F7F9FC] p-5 shadow-sm sm:mt-6 sm:p-6 md:rounded-[32px] md:p-8">
        ...
        <div className="mt-6 rounded-[24px] border border-[#D9E2F0] bg-white px-4 py-4 text-sm leading-7 text-[#374151] shadow-sm">
          <p className="text-sm font-semibold text-[#111827]">{copy.seoIntroTitle}</p>
          <p className="mt-2">{copy.seoIntroDescription}</p>
        </div>
